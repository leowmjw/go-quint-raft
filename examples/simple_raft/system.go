...
node := d.pickNode(step, "node")
d.triggerElection(node)
case "grantVote":
voter := d.pickNode(step, "voter")
candidateID := d.pickNode(step, "candidate")
...
func (d *SimpleRaftDriver) pickNode(step *connector.Step, name string) string {
